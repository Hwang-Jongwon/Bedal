...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder>{
    private String[] title, context, time, meter;
    private double[] x, y;
    private String UID, currentTime;
    private double lati, longi;

    public MyAdapter(String[] title_list, String[] context_list, String[] time_list, double[] x_list, double[] y_list, String Uid, double lati, double longi, String currentTime, String[] meter_list){
